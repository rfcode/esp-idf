...
if [ -z ${IDF_PATH} ]; then
	...
	IDF_ADD_PATHS_EXTRAS="${IDF_PATH}/components/esptool_py/esptool:${IDF_PATH}/components/espcoredump:${IDF_PATH}/components/partition_table/:$IDF_PATH/components/spiffs/"
